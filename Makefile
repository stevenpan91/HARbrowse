...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Fri Jan 13 06:03:31 2017
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HARbrowse1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/HARbrowse1.0.0/ && (cd `dirname .tmp/HARbrowse1.0.0` && $(TAR) HARbrowse1.0.0.tar HARbrowse1.0.0 && $(COMPRESS) HARbrowse1.0.0.tar) && $(MOVE) `dirname .tmp/HARbrowse1.0.0`/HARbrowse1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HARbrowse1.0.0

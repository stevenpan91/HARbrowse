...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sun Jan 15 23:39:53 2017
# Project:  HARbrowse.pro
# Template: app
# Command: /bin/qmake-qt4 -o Makefile HARbrowse.pro
#############################################################################
...
INCPATH       = -I/usr/lib64/qt4/mkspecs/linux-g++ -I. -I/usr/include/QtCore -I/usr/include/QtNetwork -I/usr/include/QtGui -I/usr/include/QtWebKit -I/usr/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-z,relro
LIBS          = $(SUBLIBS)  -L/usr/lib64 -lQtWebKit -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /bin/qmake-qt4
TAR           = tar -cf
...
Makefile: HARbrowse.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/HARbrowse1.0.0 || $(MKDIR) .tmp/HARbrowse1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/HARbrowse1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/HARbrowse1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/HARbrowse1.0.0/ && (cd `dirname .tmp/HARbrowse1.0.0` && $(TAR) HARbrowse1.0.0.tar HARbrowse1.0.0 && $(COMPRESS) HARbrowse1.0.0.tar) && $(MOVE) `dirname .tmp/HARbrowse1.0.0`/HARbrowse1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/HARbrowse1.0.0
